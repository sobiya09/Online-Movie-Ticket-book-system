<%-- 
    Document   : viewusers
    Created on : Aug 6, 2024, 3:15:14 PM
    Author     : sobi
--%>
...
<html>
    ...
    <body>
        <div class="sidebar">
            ...
            <a class="active" href="./viewusers.jsp"><i class="fas fa-user"></i>View Users</a>
        ...
        <div class="content">
            <div class="container mt-5">
                <h1 class="text-center h1hed" style="color:maroon;">Users Details</h1>
