<%-- 
    ...
    Created on : Aug 9, 2024, 2:59:21 PM
    Author     : sobi
--%>
...
<html>
    ...
    <body>
        <div class="sidebar">
            ...
            <a class="active"href="viewbooking.jsp"><i class="fas fa-ticket"></i>Bookings</a>
        ...
        <div class="content">
            <div class="container mt-5">
                <h1 class="text-center h1hed" style="color:maroon;">Booking Details</h1>
