<%-- 
    Document   : view
    Created on : Jul 16, 2024, 6:31:48 PM
    Author     : sobi
--%>
...
<html>
    ...
    <body>
        <div class="sidebar">
            ...
            <a class="active" href="./view.jsp"><i class="fas fa-eye"></i> View Movies</a>
        ...
        <div class="content">
            <div class="container mt-5">
                <h1 class="text-center h1hed" style="color:maroon;">All Movie Details</h1>
