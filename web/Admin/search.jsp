<%-- 
    Document   : search
    Created on : Jul 13, 2024, 3:57:10 PM
    Author     : sobi
--%>
    ...
    <body>
        ...
        <div class="content">
            <div class="container mt-5">
                <h1 class="text-center h1hed" style="color:maroon">Search Movies</h1>

                <form action="searchresult.jsp" method="post" class="mt-4">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="Search Movie by language, title, Category, Director, or Movie_ID">
